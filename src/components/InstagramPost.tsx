...
export default function InstagramPost({ postId }: InstagramPostProps) {
  useEffect(() => {
    if (window.instgrm) {
  ...
  const permalink = `https://www.instagram.com/p/${postId}/?utm_source=ig_embed&utm_campaign=loading`;
      ...
      >
        <div style={{ padding: '16px' }}>
          ...
          <p style={{ margin: '8px 0 0 0', padding: '0 4px' }}>
            <a href={permalink} style={{ color: '#000', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }} target="_blank" rel="noopener noreferrer">A post shared by WithU International Center (@with_u_center)</a>
          </p>
        </div>
      </blockquote>
    </div>
